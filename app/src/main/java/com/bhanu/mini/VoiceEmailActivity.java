...
//        try {
//
//            Session AuthSession = SendMailSSL.authenticate(vmActivity, editTxtFrom, password);
//
//            //compose message
//            MimeMessage message = SendMailSSL.composeMessage(
//                    vmActivity,
//                    AuthSession,
//                    toEmail,
//                    ccEmail,
...
//    private MimeMessage composeMessage(Session session,
//                                       String toEmail,
//                                       String ccEmail,
//                                       String bccEmail) {
//
...
//
//            Toast.makeText(getApplicationContext(),
//                    "Could not compose message" + e.getMessage(),
//                    Toast.LENGTH_LONG)
//                    .show();
//        }
//
...
//
//            Toast.makeText(getApplicationContext(),
//                    "Could not add recipients" + type + e.getMessage(),
//                    Toast.LENGTH_LONG)
//                    .show();
//        }
//
...
//        } catch (Exception e) {
//            Toast.makeText(getApplicationContext(),
//                    "Email Could not authenticate" + e.getMessage(),
//                    Toast.LENGTH_LONG)
//                    .show();
//        }
//
